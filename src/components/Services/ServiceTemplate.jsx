...
const ServiceTemplate = ({
  ...
  const finalSeoTitle = seoTitle || `${title} Services | Dsigner Studio Interiors Hyderabad`;
  const finalSeoDescription = seoDescription || `Professional ${title} services in Hyderabad. Expert solutions tailored to your needs. Contact us for a free consultation.`;
  const finalSeoKeywords = seoKeywords || `${title}, ${title} services Hyderabad, professional ${title}, interior design`;
