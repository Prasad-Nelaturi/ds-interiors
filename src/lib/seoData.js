...
export const routeSEO = {
    ...
    "/projects": {
        ...
        description:
            "Browse our portfolio of residential, commercial, and luxury interior design projects in Hyderabad.",
        keywords:
    ...
    "/modular-factory": {
        ...
        description:
            "Discover our state-of-the-art modular factory for custom interior solutions.",
        keywords:
            "modular factory Hyderabad, custom modular furniture, kitchen cabinets, wardrobes, modular interiors",
    },

    "/privacy-policy": {
        title: "Privacy Policy | Dsigner Studio Interiors Hyderabad",
        description:
    ...
    "/terms-conditions": {
        title: "Terms & Conditions | Dsigner Studio Interiors Hyderabad",
        description:
    ...
    "/services/3d-visualization": {
        ...
        description:
            "High-quality 3D visualization and rendering services. See your interior designs before implementation.",
        keywords:
    ...
    "/services/home-plans": {
        ...
        keywords:
            "home plans Hyderabad, floor plan design, house layout design, space planning",
    },

    "/services/landscaping": {
        title: "Landscaping & Outdoor Design | Dsigner Studio Interiors Hyderabad",
        description:
            "Professional landscaping and outdoor design services in Hyderabad.",
        keywords:
            "landscaping Hyderabad, garden design, outdoor spaces, landscape architecture",
    },
    ...
    "/services/home-automation": {
        ...
        keywords:
            "home automation Hyderabad, smart home, automated lighting, home security",
    },

    "/services/curtains-blinds": {
        title: "Curtains & Blinds Design | Dsigner Studio Interiors Hyderabad",
        description:
            "Custom curtains and blinds design services in Hyderabad.",
        keywords:
            "curtains Hyderabad, blinds Hyderabad, window treatments, custom curtains",
    },

    "/services/chimneys-hobs": {
        title: "Chimneys & Hobs Installation | Dsigner Studio Interiors",
        description:
            "Professional chimneys and hobs installation services in Hyderabad.",
        keywords:
    ...
    "/services/space-planning": {
        ...
        description:
            "Expert space planning and optimization services in Hyderabad.",
        keywords:
            "space planning Hyderabad, space optimization, interior layout design",
    },

    "/services/styling": {
        title: "Interior Styling & Decor | Dsigner Studio Interiors Hyderabad",
        description:
            "Professional interior styling and decor services in Hyderabad.",
        keywords:
            "interior styling Hyderabad, home decor, interior decoration, furniture styling",
    },

    /*
     * Admin page should never be indexed.
     */
    "/admin/create-blog": {
